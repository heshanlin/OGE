...
def printHelp():
    ...
    print "\tlistPlugins"
    print "\tcreatePluginTemplate <plugin_id>"
    print "\tremovePlugin <plugin_id>"
    print "\tqueryPlugin <plugin_id>"
    print "\ttestPlugin <plugin_id> [--para1 val1] [--para2 val2] ..."
    print "\texecutePlugin <plugin_id> [--para1 val1] [--para2 val2] ..."
    print "\tlistWorkflows"
    print "\tcreateWorkflow <workflow_id>"
    print "\tremoveWorkflow <workflow_id>"
    print "\tqueryWorkflow <workflow_id>"
    print "\ttestWorkflow <workflow_id> [--para1 val1] [--para2 val2] ..."
    print "\texecuteWorkflow <workflow_id> [--para1 val1] [--para2 val2] ..."
    print "\tlistSuites"
    print "\tremoveSuite"
